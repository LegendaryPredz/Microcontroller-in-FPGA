...
HD_PWD='C:/Users/Chick/Microcontroller in FPGA/Microcontroller in FPGA.runs/design_1_led_fsm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_led_fsm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_led_fsm_0_0.tcl
